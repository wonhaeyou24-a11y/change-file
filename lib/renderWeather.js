...
function buildLayout(data, opts = {}) {
  ...
  return {
    ...
    tableNo: opts.tableNo || "6.2-5",
    caption: opts.caption || "기상청 강수량 분석 결과",
...
async function buildWeatherDocx(data, opts = {}) {
  ...
  children.push(new Paragraph({
    alignment: AlignmentType.CENTER,
    spacing: { after: 120 },
    children: [new TextRun({ text: `<표 ${L.tableNo}> ${L.caption}`, font: FONT, size: 20, bold: true })],
  }));
  children.push(table);
